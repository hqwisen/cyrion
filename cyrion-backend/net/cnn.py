...
class myDATA:
    ...
    def __init__(self):
        ...
        self.trainX, self.trainY, self.testX, self.testY = None, None, None, None  # first kind of data : digits & letters
        self.train_X, self.train_Y, self.test_X, self.test_Y = None, None, None, None  # second kind of data : operators
